...
-- CreateEnum
CREATE TYPE "SubtaskStatus" AS ENUM ('PENDING', 'PROCESSING', 'DONE', 'FAILED');

-- CreateEnum
CREATE TYPE "ActionType" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_MOVED', 'TASK_DELETED', 'COMMENT_ADDED', 'COMMENT_DELETED', 'ATTACHMENT_ADDED', 'SUBTASKS_GENERATED', 'PROJECT_CREATED', 'PROJECT_UPDATED');
...
CREATE TABLE "tasks" (
    ...
    "subtaskStatus" "SubtaskStatus" NOT NULL DEFAULT 'PENDING',
    "dueDate" TIMESTAMP(3),
